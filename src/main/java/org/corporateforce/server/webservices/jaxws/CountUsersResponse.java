...
@XmlRootElement(name = "countUsersResponse", namespace = "http://webservices.server.corporateforce.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "countUsersResponse", namespace = "http://webservices.server.corporateforce.org/")
