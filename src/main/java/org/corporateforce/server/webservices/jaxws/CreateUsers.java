...
@XmlRootElement(name = "createUsers", namespace = "http://webservices.server.corporateforce.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createUsers", namespace = "http://webservices.server.corporateforce.org/")
