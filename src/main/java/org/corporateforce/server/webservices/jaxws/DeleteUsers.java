...
@XmlRootElement(name = "deleteUsers", namespace = "http://webservices.server.corporateforce.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteUsers", namespace = "http://webservices.server.corporateforce.org/")
