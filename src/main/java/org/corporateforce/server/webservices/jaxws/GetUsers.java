...
@XmlRootElement(name = "getUsers", namespace = "http://webservices.server.corporateforce.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getUsers", namespace = "http://webservices.server.corporateforce.org/")
